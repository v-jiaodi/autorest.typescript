...
import { ValidateOperationTriggerOptionalParams } from "./options.js";
import {
  StreamableMethod,
...
export async function _triggerDeserialize(
...
export function trigger(
  ...
  return getLongRunningPoller(context, _triggerDeserialize, ["202", "200"], {
