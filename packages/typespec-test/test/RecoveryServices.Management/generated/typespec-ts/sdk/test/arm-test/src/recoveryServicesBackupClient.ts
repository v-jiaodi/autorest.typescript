...
import {
  ...
  _getBackupJobsOperations,
} from "./classic/backupJobs/index.js";
import {
...
import {
  ...
  _getJobDetailsOperations,
} from "./classic/jobDetails/index.js";
import {
...
import {
  OperationOperations,
  _getOperationOperations,
} from "./classic/operation/index.js";
import {
...
import {
  RestoresOperations,
  _getRestoresOperations,
} from "./classic/restores/index.js";
import {
...
export class RecoveryServicesBackupClient {
  ...
  constructor(
    ...
    this.privateEndpointConnection = _getPrivateEndpointConnectionOperations(
      this._client,
    );
    this.protectionIntent = _getProtectionIntentOperations(this._client);
    this.tieringCostOperationStatus = _getTieringCostOperationStatusOperations(
      this._client,
    );
    this.getTieringCostOperationResult =
      _getGetTieringCostOperationResultOperations(this._client);
    ...
    this.deletedProtectionContainers =
      _getDeletedProtectionContainersOperations(this._client);
    this.backupProtectionContainers = _getBackupProtectionContainersOperations(
      this._client,
    );
    this.backupProtectableItems = _getBackupProtectableItemsOperations(
      this._client,
    );
    this.backupOperationStatuses = _getBackupOperationStatusesOperations(
      this._client,
    );
    this.backupOperationResults = _getBackupOperationResultsOperations(
      this._client,
    );
    this.protectableContainers = _getProtectableContainersOperations(
      this._client,
    );
    this.protectionContainerRefreshOperationResults =
      _getProtectionContainerRefreshOperationResultsOperations(this._client);
    this.validateOperationStatuses = _getValidateOperationStatusesOperations(
      this._client,
    );
    this.validateOperationResults = _getValidateOperationResultsOperations(
      this._client,
    );
    this.validateOperation = _getValidateOperationOperations(this._client);
    this.backupProtectedItems = _getBackupProtectedItemsOperations(
      this._client,
    );
    this.jobs = _getJobsOperations(this._client);
    this.backupUsageSummaries = _getBackupUsageSummariesOperations(
      this._client,
    );
    this.backupProtectionIntent = _getBackupProtectionIntentOperations(
      this._client,
    );
    this.featureSupport = _getFeatureSupportOperations(this._client);
    this.backupStatus = _getBackupStatusOperations(this._client);
    this.resourceGuardProxies = _getResourceGuardProxiesOperations(
      this._client,
    );
    ...
    this.exportJobsOperationResults = _getExportJobsOperationResultsOperations(
      this._client,
    );
    ...
    this.protectionPolicyOperationStatuses =
      _getProtectionPolicyOperationStatusesOperations(this._client);
    this.protectionPolicyOperationResults =
      _getProtectionPolicyOperationResultsOperations(this._client);
    ...
    this.itemLevelRecoveryConnections =
      _getItemLevelRecoveryConnectionsOperations(this._client);
    ...
    this.protectionContainerOperationResults =
      _getProtectionContainerOperationResultsOperations(this._client);
    this.backupWorkloadItems = _getBackupWorkloadItemsOperations(this._client);
    this.protectionContainers = _getProtectionContainersOperations(
      this._client,
    );
    this.protectedItemOperationResults =
      _getProtectedItemOperationResultsOperations(this._client);
    this.protectedItemOperationStatuses =
      _getProtectedItemOperationStatusesOperations(this._client);
    this.recoveryPointsRecommendedForMove =
      _getRecoveryPointsRecommendedForMoveOperations(this._client);
    ...
    this.backupResourceEncryptionConfigs =
      _getBackupResourceEncryptionConfigsOperations(this._client);
    this.backupResourceVaultConfigs = _getBackupResourceVaultConfigsOperations(
      this._client,
    );
    this.bmsPrepareDataMoveOperationResult =
      _getBMSPrepareDataMoveOperationResultOperations(this._client);
    this.backupResourceStorageConfigsNonCRR =
      _getBackupResourceStorageConfigsNonCRROperations(this._client);
