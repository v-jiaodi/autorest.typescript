 ...
 * scoped results.
 * x-ms-original-file: 2025-02-01/AzureIaasVm/BackupPolicies_List.json
 */
 ...
 * @summary lists of backup policies associated with Recovery Services Vault. API provides pagination parameters to fetch
 * scoped results.
 * x-ms-original-file: 2025-02-01/AzureIaasVm/V2Policy/v2-List-Policies.json
 */
 ...
 * @summary lists of backup policies associated with Recovery Services Vault. API provides pagination parameters to fetch
 * scoped results.
 * x-ms-original-file: 2025-02-01/AzureWorkload/BackupPolicies_List.json
 */
