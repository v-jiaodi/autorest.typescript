 ...
 * Status of the operation can be fetched using GetTieringCostOperationStatus API and result using GetTieringCostOperationResult API.
 * x-ms-original-file: 2025-02-01/TieringCost/FetchTieringCostForPolicy.json
 */
async function getTheTieringSavingsCostInfoForPolicy(): Promise<void> {
  const credential = new DefaultAzureCredential();
  const subscriptionId = "00000000-0000-0000-0000-000000000000";
  const client = new RecoveryServicesBackupClient(credential, subscriptionId);
  const result = await client.fetchTieringCost.post(
    "netsdktestrg",
    "testVault",
    {
 ...
 * @summary provides the details of the tiering related sizes and cost.
 * Status of the operation can be fetched using GetTieringCostOperationStatus API and result using GetTieringCostOperationResult API.
 * x-ms-original-file: 2025-02-01/TieringCost/FetchTieringCostForProtectedItem.json
 */
 ...
 * @summary provides the details of the tiering related sizes and cost.
 * Status of the operation can be fetched using GetTieringCostOperationStatus API and result using GetTieringCostOperationResult API.
 * x-ms-original-file: 2025-02-01/TieringCost/FetchTieringCostForRehydrate.json
 */
 ...
 * @summary provides the details of the tiering related sizes and cost.
 * Status of the operation can be fetched using GetTieringCostOperationStatus API and result using GetTieringCostOperationResult API.
 * x-ms-original-file: 2025-02-01/TieringCost/FetchTieringCostForVault.json
 */
