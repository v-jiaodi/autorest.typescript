...
import { FetchTieringCostPostOptionalParams } from "./options.js";
import {
  StreamableMethod,
...
export function post(
  ...
  return getLongRunningPoller(context, _postDeserialize, ["200", "202"], {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
      _postSend(context, resourceGroupName, vaultName, parameters, options),
