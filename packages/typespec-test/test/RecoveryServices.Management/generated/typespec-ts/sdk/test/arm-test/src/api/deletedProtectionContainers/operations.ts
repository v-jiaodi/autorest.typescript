...
import { DeletedProtectionContainersListOptionalParams } from "./options.js";
import {
  StreamableMethod,
...
export function _listSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupDeletedProtectionContainers{?api%2Dversion,%24filter}",
    {
