...
export async function getEntryStatement(
  ...
  const result = await _getEntryStatementSend(context, entryId, options);
...
export async function getEntry(
  ...
  const result = await _getEntrySend(context, entryId, options);
...
export async function createEntry(
  ...
  const result = await _createEntrySend(context, body, options);
...
export async function getTransparencyConfigCbor(
  ...
  const result = await _getTransparencyConfigCborSend(context, options);
