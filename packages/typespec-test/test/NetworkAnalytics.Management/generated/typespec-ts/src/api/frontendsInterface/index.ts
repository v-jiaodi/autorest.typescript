...
/** Create a Frontend */
export async function frontendsInterfaceCreateOrUpdate(
  context: Client,
  subscriptionId: string,
  resourceGroupName: string,
  trafficControllerName: string,
  ...
  const result = await _frontendsInterfaceCreateOrUpdateSend(
    context,
    subscriptionId,
    resourceGroupName,
    trafficControllerName,
  ...
  return _frontendsInterfaceCreateOrUpdateDeserialize(result);
}
...
/** Delete a Frontend */
export async function frontendsInterfaceDeleteOperation(
  context: Client,
  subscriptionId: string,
  resourceGroupName: string,
  trafficControllerName: string,
  ...
  const result = await _frontendsInterfaceDeleteOperationSend(
    context,
    subscriptionId,
    resourceGroupName,
    trafficControllerName,
  ...
  return _frontendsInterfaceDeleteOperationDeserialize(result);
}
