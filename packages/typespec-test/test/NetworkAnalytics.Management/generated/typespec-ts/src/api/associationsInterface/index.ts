...
export async function associationsInterfaceCreateOrUpdate(
  context: Client,
  subscriptionId: string,
  resourceGroupName: string,
  trafficControllerName: string,
  ...
  const result = await _associationsInterfaceCreateOrUpdateSend(
    context,
    subscriptionId,
    resourceGroupName,
    trafficControllerName,
  ...
  return _associationsInterfaceCreateOrUpdateDeserialize(result);
}
...
export async function associationsInterfaceDeleteOperation(
  context: Client,
  subscriptionId: string,
  resourceGroupName: string,
  trafficControllerName: string,
  ...
  const result = await _associationsInterfaceDeleteOperationSend(
    context,
    subscriptionId,
    resourceGroupName,
    trafficControllerName,
  ...
  return _associationsInterfaceDeleteOperationDeserialize(result);
}
