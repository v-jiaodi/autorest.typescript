...
export async function trafficControllerInterfaceCreateOrUpdate(
  context: Client,
  subscriptionId: string,
  resourceGroupName: string,
  trafficControllerName: string,
  ...
  const result = await _trafficControllerInterfaceCreateOrUpdateSend(
    context,
    subscriptionId,
    resourceGroupName,
    trafficControllerName,
  ...
  return _trafficControllerInterfaceCreateOrUpdateDeserialize(result);
}
...
export async function trafficControllerInterfaceDeleteOperation(
  context: Client,
  subscriptionId: string,
  resourceGroupName: string,
  trafficControllerName: string,
  ...
  const result = await _trafficControllerInterfaceDeleteOperationSend(
    context,
    subscriptionId,
    resourceGroupName,
    trafficControllerName,
  ...
  return _trafficControllerInterfaceDeleteOperationDeserialize(result);
}
