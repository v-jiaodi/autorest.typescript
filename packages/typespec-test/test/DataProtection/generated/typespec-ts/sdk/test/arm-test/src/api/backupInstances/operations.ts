...
export function validateCrossRegionRestore(
  ...
  OperationState<OperationJobExtendedInfo>,
  OperationJobExtendedInfo
> {
  return getLongRunningPoller(
    ...
    ["200", "202"],
    {
      ...
      getInitialResponse: () =>
        _validateCrossRegionRestoreSend(
          context,
          resourceGroupName,
          location,
          parameters,
...
> {
  return getLongRunningPoller(
    ...
    ["200", "202"],
    {
      ...
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _triggerCrossRegionRestoreSend(
          context,
          resourceGroupName,
          location,
          parameters,
...
> {
  return getLongRunningPoller(
    context,
    _validateForRestoreDeserialize,
    ["200", "202"],
    {
      updateIntervalInMs: options?.updateIntervalInMs,
      abortSignal: options?.abortSignal,
...
export async function _syncBackupInstanceDeserialize(
  result: PathUncheckedResponse,
): Promise<void> {
  const expectedStatuses = ["200", "202"];
  if (!expectedStatuses.includes(result.status)) {
...
export function syncBackupInstance(
  ...
  return getLongRunningPoller(
    context,
    _syncBackupInstanceDeserialize,
    ["200", "202"],
    {
      updateIntervalInMs: options?.updateIntervalInMs,
      abortSignal: options?.abortSignal,
        ...
        ...(options?.xMsAuthorizationAuxiliary !== undefined
          ? {
              "x-ms-authorization-auxiliary":
                options?.xMsAuthorizationAuxiliary,
            }
          : {}),
        ...options.requestOptions?.headers,
      },
...
export async function _suspendBackupsDeserialize(
  result: PathUncheckedResponse,
): Promise<void> {
  const expectedStatuses = ["200", "202"];
  if (!expectedStatuses.includes(result.status)) {
...
export async function _stopProtectionDeserialize(
  result: PathUncheckedResponse,
): Promise<void> {
  const expectedStatuses = ["200", "202"];
  if (!expectedStatuses.includes(result.status)) {
...
export async function _resumeProtectionDeserialize(
  result: PathUncheckedResponse,
): Promise<void> {
  const expectedStatuses = ["200", "202"];
  if (!expectedStatuses.includes(result.status)) {
...
export function resumeProtection(
  ...
  return getLongRunningPoller(
    context,
    _resumeProtectionDeserialize,
    ["200", "202"],
    {
      updateIntervalInMs: options?.updateIntervalInMs,
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _resumeProtectionSend(
          context,
          resourceGroupName,
          vaultName,
          backupInstanceName,
...
export async function _resumeBackupsDeserialize(
  result: PathUncheckedResponse,
): Promise<void> {
  const expectedStatuses = ["200", "202"];
  if (!expectedStatuses.includes(result.status)) {
...
export async function _triggerRehydrateDeserialize(
  result: PathUncheckedResponse,
): Promise<void> {
...
export function validateForModifyBackup(
  ...
  return getLongRunningPoller(
    context,
    _validateForModifyBackupDeserialize,
    ["202", "200"],
    {
      updateIntervalInMs: options?.updateIntervalInMs,
      abortSignal: options?.abortSignal,
...
export function createOrUpdate(
  ...
  return getLongRunningPoller(
    ...
    OperationState<BackupInstanceResource>,
    BackupInstanceResource
  >;
}
...
> {
  return getLongRunningPoller(
    context,
    _validateForBackupDeserialize,
    ["200", "202"],
    {
      updateIntervalInMs: options?.updateIntervalInMs,
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _validateForBackupSend(
          context,
          resourceGroupName,
          vaultName,
          parameters,
