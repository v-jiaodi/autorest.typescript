...
export function _getInResourceGroupSend(
  context: Client,
  resourceGroupName: string,
...
export async function _getInResourceGroupDeserialize(
  result: PathUncheckedResponse,
...
export function getInResourceGroup(
  context: Client,
  resourceGroupName: string,
  options: BackupVaultsGetInResourceGroupOptionalParams = {
    requestOptions: {},
  ...
  return buildPagedAsyncIterator(
    context,
    () => _getInResourceGroupSend(context, resourceGroupName, options),
    _getInResourceGroupDeserialize,
    ["200"],
...
export function _getInSubscriptionSend(
  context: Client,
  options: BackupVaultsGetInSubscriptionOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function getInSubscription(
  context: Client,
  options: BackupVaultsGetInSubscriptionOptionalParams = { requestOptions: {} },
): PagedAsyncIterableIterator<BackupVaultResource> {
  return buildPagedAsyncIterator(
    context,
    () => _getInSubscriptionSend(context, options),
    _getInSubscriptionDeserialize,
    ["200"],
    { itemName: "value", nextLinkName: "nextLink" },
  );
}
...
export function $delete(
  ...
  return getLongRunningPoller(
    ...
    ["200", "202", "204"],
    {
      ...
      getInitialResponse: () =>
        _$deleteSend(context, resourceGroupName, vaultName, options),
