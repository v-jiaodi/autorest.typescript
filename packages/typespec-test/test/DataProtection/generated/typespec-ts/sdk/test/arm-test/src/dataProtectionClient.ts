...
import {
  ...
  _getExportJobsOperations,
} from "./classic/exportJobs/index.js";
import {
...
export class DataProtectionClient {
  ...
  constructor(
    ...
    this.backupInstancesExtensionRouting =
      _getBackupInstancesExtensionRoutingOperations(this._client);
    this.fetchCrossRegionRestoreJobs =
      _getFetchCrossRegionRestoreJobsOperations(this._client);
    this.fetchCrossRegionRestoreJob = _getFetchCrossRegionRestoreJobOperations(
      this._client,
    );
    this.fetchSecondaryRecoveryPoints =
      _getFetchSecondaryRecoveryPointsOperations(this._client);
    this.dataProtection = _getDataProtectionOperations(this._client);
    this.operationStatusResourceGroupContext =
      _getOperationStatusResourceGroupContextOperations(this._client);
    ...
    this.dppResourceGuardProxy = _getDppResourceGuardProxyOperations(
      this._client,
    );
    this.deletedBackupInstances = _getDeletedBackupInstancesOperations(
      this._client,
    );
    this.jobs = _getJobsOperations(this._client);
    this.recoveryPoints = _getRecoveryPointsOperations(this._client);
    this.restorableTimeRanges = _getRestorableTimeRangesOperations(
      this._client,
    );
    this.backupPolicies = _getBackupPoliciesOperations(this._client);
    this.exportJobsOperationResult = _getExportJobsOperationResultOperations(
      this._client,
    );
    this.exportJobs = _getExportJobsOperations(this._client);
    this.operationStatusBackupVaultContext =
      _getOperationStatusBackupVaultContextOperations(this._client);
    ...
    this.backupVaultOperationResults =
      _getBackupVaultOperationResultsOperations(this._client);
    this.backupInstances = _getBackupInstancesOperations(this._client);
    this.dataProtectionOperations = _getDataProtectionOperationsOperations(
      this._client,
    );
  }
